...
public class FaultListActivity extends Activity {
	...
	private static final String[] type = { "未完成工单", "已完成工单","集客未完成工单","集客已完成工单" };
...
//		}
		...
		SelectEndDateButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) 
			{
				...
				DatePickerDialog datePicker=new DatePickerDialog(FaultListActivity.this, new OnDateSetListener() {
		...
		ShowDataButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) 
			{
				...
				{
					Toast.makeText(FaultListActivity.this, "请选择时间！",Toast.LENGTH_SHORT).show();
					return;
				}else
				{
					...
					if (typestr.equals("未完成工单"))
						...
						typeID = "2";
					else if (typestr.equals("集客未完成工单"))
						typeID = "3";
					else if (typestr.equals("集客已完成工单"))
						typeID = "4";
					else
						typeID = "5";
	...
	public void loadListview(String country, String typeID, String Date,String EndDate,String Name) {
		...
		new AsyncTask<String, Void, List<HashMap<String, String>>>() {
			...
			protected List<HashMap<String, String>> doInBackground(
				...
				return dbUtil.GetAllFaultJob(params[0], params[1], params[2],params[3],params[4],params[5],params[6]);
			}
			...
			protected void onPostExecute(List<HashMap<String, String>> result) {
				...
				if (result==null || result.size() == 0) {
					Toast.makeText(FaultListActivity.this, "没有数据！",Toast.LENGTH_SHORT).show();
					...
					if(Power.equals("维护人员"))
					{
						adapter = new SimpleAdapter(
								FaultListActivity.this, result,
								R.layout.install_listview_div_zw, new String[] { "ID","派单时间","片区","小区","接单人","当前状态","耗时"}, new int[] { R.id.Id,R.id.StrDatetime,R.id.area,R.id.cell,R.id.installperson,R.id.State,R.id.usedtime});
					}else{
							adapter = new SimpleAdapter(
							FaultListActivity.this, result,
							R.layout.install_listview_div, new String[] { "ID","派单时间","片区","小区","故障地址","当前状态","耗时"}, new int[] { R.id.Id,R.id.StrDatetime,R.id.area,R.id.cell,R.id.address,R.id.State,R.id.usedtime});
					}
					...
					//if (spinner_type.getSelectedItem().equals("未完成订单") || spinner_type.getSelectedItem().equals("已完成订单")) 
					{
						listview.setOnItemClickListener(new OnItemClickListener() {
							...
							public void onItemClick(
								...
								Intent intent;
								intent = new Intent(FaultListActivity.this,FaultSinglequerryActivity.class);
								// 用Bundle携带数据
			...
			protected void onPreExecute() {
				// TODO Auto-generated method stub
				toast=Toast.makeText(FaultListActivity.this, "查询中...",Toast.LENGTH_SHORT);
				toast.show();
				super.onPreExecute();
			}
