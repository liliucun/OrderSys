...
public class ZdListActivity extends Activity {
	private static final String[] country = { "榆阳区", "神木", "府谷", "定边", "靖边",	"横山", "绥德", "米脂", "佳县", "吴堡", "清涧", "子洲", "大柳塔"};
	private static final String[] type = { "未完成工单", "已完成工单","办理成功工单","办理失败工单" };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SelectEndDateButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) 
			{
				...
				DatePickerDialog datePicker=new DatePickerDialog(ZdListActivity.this, new OnDateSetListener() {
		...
		ShowDataButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) 
			{
				...
				{
					Toast.makeText(ZdListActivity.this, "请选择时间！",Toast.LENGTH_SHORT).show();
					return;
				}else
				{
					...
					if (typestr.equals("未完成工单"))
						...
						typeID = "2";
					else if (typestr.equals("办理成功工单"))
						typeID = "3";
					else if (typestr.equals("办理失败工单"))
						typeID = "4";
					else
						typeID = "5";
	...
	public void loadListview(String country, String typeID, String Date,String EndDate,String Name) {
		...
		new AsyncTask<String, Void, List<HashMap<String, String>>>() {
			...
			protected List<HashMap<String, String>> doInBackground(
				...
				return dbUtil.GetAllZdJob(params[0], params[1], params[2],params[3],params[4],params[5],params[6]);
			}
			...
			protected void onPostExecute(List<HashMap<String, String>> result) {
				...
				if (result==null || result.size() == 0) {
					Toast.makeText(ZdListActivity.this, "没有数据！",Toast.LENGTH_SHORT).show();
					listview.setAdapter(null);
				} 
				else {
					SimpleAdapter adapter=null;
					adapter = new SimpleAdapter(
					ZdListActivity.this, result,
					R.layout.zd_listview_div, new String[] { "ID","派单时间","县区","片区","接单人","机型","当前状态","耗时"}, new int[] { R.id.Id,R.id.StrDatetime,R.id.county,R.id.area,R.id.receiver,R.id.phonetype,R.id.State,R.id.usedtime});
					...
					//if (spinner_type.getSelectedItem().equals("未完成订单") || spinner_type.getSelectedItem().equals("已完成订单")) 
					{
						listview.setOnItemClickListener(new OnItemClickListener() {
							...
							public void onItemClick(
								...
								Intent intent;
								intent = new Intent(ZdListActivity.this,ZdDetailActivity.class);
								// 用Bundle携带数据
			...
			protected void onPreExecute() {
				// TODO Auto-generated method stub
				toast=Toast.makeText(ZdListActivity.this, "查询中...",Toast.LENGTH_SHORT);
				toast.show();
				super.onPreExecute();
			}

		}.execute(country, typeID, Date,EndDate,((AppData)getApplication()).getRole(),((AppData)getApplication()).getUser(),Name);
